...
{
	/// <summary>
	/// Creates a link as a sub type of the base class or interface
	/// </summary>
	[AttributeUsage(AttributeTargets.Class, AllowMultiple = true)]
	public sealed class ProtoBaseAttribute : Attribute
	{
		/// <summary>
		...
		public ProtoBaseAttribute(int fieldNumber)
		{
		...
		public ProtoBaseAttribute(int fieldNumber, Type concreteType)
			: this(fieldNumber)
		{
